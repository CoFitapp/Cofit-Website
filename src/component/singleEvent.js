...
export default function SingleEvent(props) {
    ...
    // const address = Array.isArray(events?.address) ? events?.address[0] : events?.address;
    ...
    const imageUrl = events?.image || '../images/CoFit-Image-Not-Found-1.jpg';
    const updatedImageUrl = imageUrl.replace('https://api.cofitapp.com/', 'https://cofitapp.com/');
                                ...
                                <Box className='sidebar'>
                                    <Box className='sidebar-inner'>
                                        ...
                                        <Box className='event-details'>
                                            ...
                                            <Box className='location'>
                                                <Typography variant='a' component='a' className='loc' href='#' target='_blank'>
                                                    {events?.address && events?.address?.link ? (
                                                        <a href={events?.address?.link} target="_blank" rel="noopener noreferrer">
                                                    ...
                                                    {events?.address && typeof events.address === 'string' && events.address.split(' ').slice(0, 5).join(' ')}
                                                </Typography>
                                            </Box>
                                        ...
                                        <Box className='map-main'>
                                            ...
                                            <Box className='map'>
                                                {events && events?.link ? (
                                                    <a href={events?.link} target="_blank" rel="noopener noreferrer">
                                                        <iframe
                                                            src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBpVX6Xl4OEftECYrN-wauMw7dpUyl6GiI&q=${encodeURIComponent(events?.address || 'USA')}`}
                                                            width="372"
                                                            height="400"
                                                            sx={{ border: 'none' }}
                                                            allowfullscreen=""
                                                            ...
                                                            title="Google Maps Embedded Location"
                                                        ></iframe>
                                                    </a>
                                                ) : (
                                                    <iframe
                        ...
                        <Container className='site-container'>
                            ...
                            <Box className='events'>
                                <Box className='events-inner'>
                                    ...
                                    <SingleEvents currentPage={props.currentPage} pagination={props.pagination} searchQuery={searchQuery} SetTotalPages={props.SetTotalPages} eventData={eventData} setEventData={setEventData} eventData2={eventData2} setEventData2={setEventData2} handleTitleClick={handleTitleClick} />
                                    {/* <SingleEvents /> */}
                                </Box>
                            </Box>
                        </Container>
